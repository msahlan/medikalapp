		...
		'has-error' : 'has-success' }}">
			...
			<div class="form-group">
		@endif
			{!! Form::label('id_kelas', 'Kelas :',['class'=> 'contro-label']) !!}
			@if (count($list_class) > 0)
			{!! Form::select('id_kelas', $list_class, null, ['class'=> 'form-control' , 'id'=> 'id_kelas',
		...
		<div class="form-group">
			...
			@if(count($list_hoby) > 0)
			@foreach($list_hoby as $key => $value)
				<div class="checkbox">
