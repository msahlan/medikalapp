	 ...
	 <div id="content">
            <div class="inner" style="min-height: 600px !important;">
               ...
               <div class="tombol-nav" style="float:left;">
                        <a href="{{ url('laporan/pembayaran')}}" class="btn btn-primary"><i class='icon icon-white icon-plus'></i>Cetak Laporan</a> 
                    </div>     
                    <br>
                    <br>
            <div class="row">
                    ...
                    @foreach ($rawatinap_list as $rawatinap)
                        <tr>
                            ...
                            <div class="box-button">
                                {{ link_to('rawatinap/' . $rawatinap->id, 'Cetak Kwitansi' ,['class'=> 'btn btn-success btn-sm']) }}
                            </div>
                            <!-- <div class="box-button">
