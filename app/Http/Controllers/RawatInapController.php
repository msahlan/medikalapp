...
class RawatInapController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('rs.rawatinap.index', compact('halaman','rawatinap_list','jumlah_rawatinap'));
    }
    ...
    public function create()
    {
        $list_pasien = Pasien::lists('nama_pasien','id');
        $list_kamar = Kamar::lists('nama_kamar','id');
        return view('rs.rawatinap.create', compact('list_kamar','list_pasien'));
    }
    ...
    public function show($id)
    {
        ...
        $pdf = PDF::loadView('pdf.cetak-kwitansi');
